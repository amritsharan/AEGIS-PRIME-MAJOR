...
export default function Dock({ 
  ...
  const dockItems = [
    ...
    },
    {
      ...
      onClick: () => onSelectView('cypher-shield'),
      isActive: activeView === 'cypher-shield'
    },
    {
      id: 'zenith-mesh',
      ...
      onClick: () => onSelectView('zenith-mesh'),
      isActive: activeView === 'zenith-mesh'
    },
    {
      id: 'autonomous-agent',
      ...
      badge: agentBackendOnline ? 'Agent:8000 Active' : 'Offline',
      onClick: () => onSelectView('autonomous-agent'),
      isActive: activeView === 'autonomous-agent'
    },
    {
      id: 'logout',
      label: 'Logout',
